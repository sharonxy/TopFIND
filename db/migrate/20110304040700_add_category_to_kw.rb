class AddCategoryToKw < ActiveRecord::Migration
  def self.up
    add_column :kws, :category, :string
  ...
  def self.down
    ...
    remove_index :kws, :name => :index_kws_on_name rescue ActiveRecord::StatementInvalid
    remove_index :kws, :name => :index_kws_on_category rescue ActiveRecord::StatementInvalid
    add_index :kws, [:name]
