class AddAnnotationToKeywords < ActiveRecord::Migration
  def self.up
    add_column :kws, :ac, :string
    add_column :kws, :description, :text
  ...
  def self.down
    remove_column :kws, :ac
    remove_column :kws, :description
    ...
    remove_index :kws, :name => :index_kws_on_name rescue ActiveRecord::StatementInvalid
    remove_index :kws, :name => :index_kws_on_ac rescue ActiveRecord::StatementInvalid
    add_index :kws, [:name]
