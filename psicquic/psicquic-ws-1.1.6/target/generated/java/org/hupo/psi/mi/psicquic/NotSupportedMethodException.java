...
public class NotSupportedMethodException extends Exception {
    ...
    public NotSupportedMethodException(String message, org.hupo.psi.mi.psicquic.PsicquicFault psicquicFault) {
        super(message);
        this.psicquicFault = psicquicFault;
    }

    public NotSupportedMethodException(String message, org.hupo.psi.mi.psicquic.PsicquicFault psicquicFault, Throwable cause) {
        super(message, cause);
        this.psicquicFault = psicquicFault;
    }
