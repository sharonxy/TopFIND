...
public class NotSupportedTypeException extends Exception {
    ...
    public NotSupportedTypeException(String message, org.hupo.psi.mi.psicquic.PsicquicFault psicquicFault) {
        super(message);
        this.psicquicFault = psicquicFault;
    }

    public NotSupportedTypeException(String message, org.hupo.psi.mi.psicquic.PsicquicFault psicquicFault, Throwable cause) {
        super(message, cause);
        this.psicquicFault = psicquicFault;
    }
