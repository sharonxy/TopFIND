class Evidence < ActiveRecord::Base
  ...
  fields do
    ...
    methodology enum_string('other','electronic annotation','COFRADIC','N-TAILS','C-TAILS','ATOMS','Edman sequencing','enzymatic biotynilation','chemical biotynilatin','MS gel band','MS semitryptic peptide','MS other','mutation analysis','unknown'), :default => 'unknown', :index => true
